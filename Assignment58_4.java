//write a java program to accept directory name from user write data of all files along with name from that directory to newly created file "Marvellous.txt"
